export const entry = [
    ...
    inputs: [
      {
        components: [
          ...
          { internalType: 'bytes', name: 'linkModuleInitData', type: 'bytes' },
        ],
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: 'string', name: 'handle', type: 'string' },
          { internalType: 'string', name: 'uri', type: 'string' },
          { internalType: 'uint256', name: 'noteCount', type: 'uint256' },
          { internalType: 'address', name: 'socialToken', type: 'address' },
          { internalType: 'address', name: 'linkModule', type: 'address' },
        ],
  ...
  {
    inputs: [{ internalType: 'uint256', name: 'linkListId', type: 'uint256' }],
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'address[]', name: 'blocklist', type: 'address[]' },
  ...
  },
  {
    inputs: [
      { internalType: 'uint256', name: 'characterId', type: 'uint256' },
      { internalType: 'address', name: 'operator', type: 'address' },
      { internalType: 'uint256', name: 'permissionBitMap', type: 'uint256' },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'address', name: 'linklist_', type: 'address' },
      { internalType: 'address', name: 'mintNFTImpl_', type: 'address' },
      { internalType: 'address', name: 'periphery_', type: 'address' },
      { internalType: 'address', name: 'newbieVilla_', type: 'address' },
    ],
    name: 'initialize',
    outputs: [],
    stateMutability: 'nonpayable',
    ...
    inputs: [
      {
        components: [
          { internalType: 'uint256', name: 'fromCharacterId', type: 'uint256' },
          { internalType: 'string', name: 'toUri', type: 'string' },
          { internalType: 'bytes32', name: 'linkType', type: 'bytes32' },
          { internalType: 'bytes', name: 'data', type: 'bytes' },
        ],
    ...
    inputs: [
      {
        components: [
          { internalType: 'uint256', name: 'fromCharacterId', type: 'uint256' },
          { internalType: 'uint256', name: 'toCharacterId', type: 'uint256' },
          { internalType: 'bytes32', name: 'linkType', type: 'bytes32' },
          { internalType: 'bytes', name: 'data', type: 'bytes' },
        ],
    ...
    inputs: [
      {
        components: [
          { internalType: 'uint256', name: 'fromCharacterId', type: 'uint256' },
          { internalType: 'uint256', name: 'toLinkListId', type: 'uint256' },
          { internalType: 'bytes32', name: 'linkType', type: 'bytes32' },
          { internalType: 'bytes', name: 'data', type: 'bytes' },
        ],
    ...
    inputs: [
      {
        components: [
          { internalType: 'uint256', name: 'fromCharacterId', type: 'uint256' },
          { internalType: 'uint256', name: 'toCharacterId', type: 'uint256' },
          { internalType: 'uint256', name: 'toNoteId', type: 'uint256' },
          { internalType: 'bytes32', name: 'linkType', type: 'bytes32' },
          { internalType: 'bytes', name: 'data', type: 'bytes' },
        ],
    ...
    inputs: [
      {
        components: [
          ...
          { internalType: 'bytes', name: 'linkModuleInitData', type: 'bytes' },
          { internalType: 'address', name: 'mintModule', type: 'address' },
          { internalType: 'bytes', name: 'mintModuleInitData', type: 'bytes' },
          { internalType: 'bool', name: 'locked', type: 'bool' },
        ],
  ...
  },
  {
    inputs: [
      {
        components: [
          { internalType: 'uint256', name: 'linklistId', type: 'uint256' },
          { internalType: 'address', name: 'linkModule', type: 'address' },
          { internalType: 'bytes', name: 'linkModuleInitData', type: 'bytes' },
        ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'string', name: 'toUri', type: 'string' },
      {
        indexed: false,
        internalType: 'bytes32',
        name: 'linkType',
