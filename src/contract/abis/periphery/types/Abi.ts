...
declare namespace DataTypes {
  ...
  export type MigrateDataStructOutput = [
    string,
    string,
    string,
    string[],
...
export interface AbiInterface extends utils.Interface {
  functions: {
    ...
    "migrate((address,string,string,address[],bytes32))": FunctionFragment;
  ...
  encodeFunctionData(
    ...
    values: [DataTypes.MigrateDataStruct]
  ): string;
...
export interface Abi extends BaseContract {
  ...
  functions: {
    ...
    migrate(
      vars: DataTypes.MigrateDataStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
